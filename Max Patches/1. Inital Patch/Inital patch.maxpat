...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 622.0, 50.5, 185.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 629.5, 145.230769230769226, 170.0, 41.0 ],
					"text" : "all output is from scaled simulation values"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 588.0, 571.0, 150.0, 34.0 ],
					"text" : "various fx mappings to create more interest."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 629.5, 89.0, 169.0, 58.0 ],
					"text" : "patching with the intent of getting working boid controlled sound"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 385.363526821136475, 753.0, 83.0, 22.0 ],
					"text" : "loadmess 130"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 399.363526821136475, 235.769230769230774, 87.0, 22.0 ],
					"text" : "loadmess 0.03"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 52.0, 3.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 125.686745941638947, 875.653846740722656, 372.0, 116.0 ],
					"varname" : "bp.Recordr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 59.0, 683.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 104.5, 390.0, 47.0, 22.0 ],
					"text" : "s cutoff"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 67.0, 483.0, 41.0, 22.0 ],
					"text" : "s mtof"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 405.363526821136475, 483.0, 81.0, 22.0 ],
					"text" : "snapshot~ 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 405.5, 513.0, 115.0, 22.0 ],
					"text" : "zmap -1. 1. 70. 120."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 405.363526821136475, 456.913574237089847, 43.0, 22.0 ],
					"text" : "cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 405.363526821136475, 428.999999999999886, 54.626508116722107, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 388.0, 622.0, 165.0, 22.0 ],
					"text" : "zmap 100. 200. 5000. 10000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 493.5, 436.0, 151.0, 22.0 ],
					"text" : "zmap 100. 200. 500. 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 493.363526821136475, 346.153846153846132, 81.0, 22.0 ],
					"text" : "snapshot~ 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 493.5, 376.153846153846132, 122.0, 22.0 ],
					"text" : "zmap -1. 1. 100. 200."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 493.363526821136475, 320.067420390936036, 43.0, 22.0 ],
					"text" : "cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 493.363526821136475, 290.461538461538453, 54.626508116722107, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 187.686745941638947, 296.153846153846132, 81.0, 22.0 ],
					"text" : "snapshot~ 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 187.823219120502472, 326.153846153846132, 109.0, 22.0 ],
					"text" : "zmap -1. 1. 0. 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 187.686745941638947, 270.067420390936036, 43.0, 22.0 ],
					"text" : "cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 187.686745941638947, 242.943019894453187, 54.626508116722107, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 319.0, 841.15384674072277, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 474.5, 817.0, 34.0, 22.0 ],
					"text" : "cos~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 474.5, 783.0, 32.0, 22.0 ],
					"text" : "/~ 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 474.5, 749.0, 40.0, 22.0 ],
					"text" : "-~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 319.0, 791.0, 96.164557576179504, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 319.0, 753.0, 49.0, 22.0 ],
					"text" : "tapout~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 319.0, 702.0, 42.0, 22.0 ],
					"text" : "tapin~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 469.835442423820496, 701.0, 44.0, 22.0 ],
					"text" : "*~ 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 469.835442423820496, 657.0, 62.0, 22.0 ],
					"text" : "phasor~ 4"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 426.5, 577.0, 88.0, 31.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 426.5, 549.0, 88.0, 22.0 ],
					"text" : "freqshift~ 1000"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 319.0, 517.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 319.0, 547.0, 47.0, 22.0 ],
					"text" : "*~ 0.55"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 319.0, 653.0, 88.0, 22.0 ],
					"text" : "onepole~ 5000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 319.0, 622.0, 66.0, 22.0 ],
					"text" : "tapout~ 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "tapconnect" ],
					"patching_rect" : [ 319.0, 587.0, 42.0, 22.0 ],
					"text" : "tapin~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 187.823219120502472, 390.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 493.5, 405.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 67.0, 450.0, 32.0, 22.0 ],
					"text" : "mtof"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 67.0, 422.0, 101.0, 22.0 ],
					"text" : "scale -1. 1. 20 90"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 67.0, 326.153846153846132, 66.0, 22.0 ],
					"text" : "listfunnel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 67.0, 525.846153846153811, 122.0, 22.0 ],
					"text" : "poly~ boids_poly 100"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 55.5, 855.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 67.0, 265.165241388174195, 69.0, 22.0 ],
					"text" : "jit.unpack 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 68.5, 89.0, 63.0, 22.0 ],
					"style" : "default",
					"text" : "jit.boids3d"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 503.0, 429.0, 465.0, 429.0, 465.0, 373.0, 397.0, 373.0, 397.0, 609.0, 397.5, 609.0 ],
					"order" : 1,
					"source" : [ "obj-104", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 503.0, 429.0, 465.0, 429.0, 465.0, 373.0, 158.5, 373.0 ],
					"order" : 2,
					"source" : [ "obj-104", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 197.323219120502472, 414.0, 142.099999999999994, 414.0 ],
					"source" : [ "obj-105", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 503.0, 498.0, 525.0, 498.0, 525.0, 543.0, 505.0, 543.0 ],
					"source" : [ "obj-125", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 415.0, 573.0, 436.0, 573.0 ],
					"source" : [ "obj-49", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-115", 0 ],
					"hidden" : 1,
					"midpoints" : [ 1200.474681735038757, 656.0, 969.487340867519379, 656.0, 969.487340867519379, 219.0, 78.0, 219.0 ],
					"source" : [ "obj-80", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-128::obj-52" : [ "Level", "Level", 0 ],
			"obj-128::obj-7" : [ "AutoName", "AutoName", 0 ],
			"obj-128::obj-73" : [ "Format", "Format", 0 ],
			"obj-128::obj-74" : [ "Channels", "Channels", 0 ],
			"obj-128::obj-76" : [ "Record", "Record", 0 ],
			"obj-128::obj-77" : [ "getsamplelength", "getsamplelength", 0 ],
			"parameterbanks" : 			{
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "E:/UNI/Final Year/Research Project/HANDIN FOLDER/Max Patches/1. Inital Patch",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
